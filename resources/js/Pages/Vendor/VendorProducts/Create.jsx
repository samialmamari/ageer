...
const NewProduct = () => {
    ...
    const handleSubmit = (e) => {
        ...
        post(route("vendorproduct.store"), {
            onSuccess: () => {
                setData("name", "");
                setData("description", "");
                setData("price", 0);
    ...
    return (
        ...
        >
            ...
            <div className="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
                <h1 className="mb-4 text-2xl font-bold"> اضف بيانات العامل</h1>
                <form
...
<select className="select select-primary w-full max-w-xs" onChange={(e) =>
  ...
  <option disabled selected>اختر الديانة </option>
    ...
    <option value="other">اخرى</option>
                        ...
                        <div className="w-full">
                            <InputLabel htmlFor="category" value="عدد سنوات الخبرة " />

                            <select className="select select-primary w-full max-w-xs" onChange={(e) =>
                                    setData("experiences", e.target.value)
                                }>
    <option disabled selected>اختر عدد سنوات الخبرة </option>
...
<div className=" flex w-full">
                    ...
                    <div className="mb-4 w-full flex flex-initial space-x-2">
                        <div className="form-control w-52">
                            <label className="cursor-pointer label">
                                <span className="label-text">العناية بالاطفال</span>
                                <input
                                    type="checkbox"
                                    className="toggle toggle-accent"
                                    onChange={(e) =>setData("is_able_care_children", e.target.checked)}
                                />
                            </label>
                        </div>
                    ...
                    <div className="mb-4 w-full flex flex-initial space-x-2">
                        <div className="form-control w-52">
                            <label className="cursor-pointer label">
                                <span className="label-text">العناية بكبار السن</span>
                                <input
                                    type="checkbox"
                                    className="toggle toggle-accent"
                                    onChange={(e) =>setData("is_able_care_elderly", e.target.checked)}
                                />
                            </label>
                        </div>
                    ...
                    <div className="mb-4 w-full flex flex-initial space-x-2">
                        <div className="form-control w-52">
                            <label className="cursor-pointer label">
                                <span className="label-text">تتكلم عربي</span>
                                <input
                                    type="checkbox"
                                    className="toggle toggle-accent"
                                    onChange={(e) =>setData("is_able_arabic", e.target.checked)}
                                />
                            </label>
                            </div>
                            </div>
                    ...
                    <div className="mb-4 w-full flex flex-initial space-x-2">
                        <div className="form-control w-52">
                            <label className="cursor-pointer label">
                                <span className="label-text">تتكلم انجليزي</span>
                                <input

                                    type="checkbox"
                                    className="toggle toggle-accent"    
                                    onChange={(e) =>setData("is_able_english", e.target.checked)}
                                />
                            </label>
                            </div>
                            </div>
                    ...
                    <PrimaryButton type="submit" label="Add Product" className="p-4 text-4xl justify-items-end">
                        {" "}
                        حفظ{" "}
                    </PrimaryButton>
                </form>
